...
class AboutUsPage:
    ...
    def open(self):
        self.driver.get(MainElements.general_url(self) + '#about')
        assert MainElements.general_url(self) + '#about' in self.driver.current_url

    def present_body_elements(self):
        xpath_selector = 3
        title = self.driver.find_element_by_xpath('//*[@id="sub-region"]/div/section/div[1]/div/h1')
        meet_the_team_title = self.driver.find_element_by_xpath('//*[@id="sub-region"]/div/section/div[2]/div/h1')
        ...
        open_positions_button = self.driver.find_element_by_xpath('//*[@id="sub-region"]/div/section/div[8]/div/p/a[1]/button')
        get_in_touch_button = self.driver.find_element_by_xpath('//*[@id="sub-region"]/div/section/div[8]/div/p/a[2]/button')
